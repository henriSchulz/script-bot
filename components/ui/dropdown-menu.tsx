...
const menuPanelClasses = cn(
  ...
  "vibrancy-strong rounded-[10px] p-1 text-popover-foreground",
...
const menuItemClasses = cn(
  ...
  "rounded-[6px] px-2 py-[5px] text-[13px] outline-none",
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(menuPanelClasses, className)}
    {...props}
  />
))
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn(
        "ml-auto text-[11px] tracking-wider text-muted-foreground/80",
        className
      )}
      {...props}
    />
